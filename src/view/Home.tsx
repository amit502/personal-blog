...
const Home = () => {
    ...
    return( 
        <div className="container">
            ...
            {
                loggedIn && <Button label="Add Admin User" 
                handleClick={ () => loggedIn ? setSignUpForm(true) : setSignUpForm(false)} 
                />
            }
            <Button 
                label={ loggedIn ? "Log Out" : "Log In"} 
                handleClick={() => loggedIn ? eraseLogin() : setLoginForm(true)}
            />
            </div>
            {
            loginForm ? 
            ...
            <div className="row">
                {
                    pageData.map(
                        (blg:IBlog) => <BlogCard {...blg} key={blg.id}/>
                    )
                }
            </div>
            <div
            ...
            <div className="displayed-page-text">
                ...
                {((page - 1) * size) + pageData.length}{" of "}{[totalCount]}
                {" Blogs"}
            </div>
                {pageData.length > 0 && (
                <ul className="pagination pull-right">
                    ...
                    <button
                        ...
                        disabled={page === 1}
                        style={{ padding: "0px", marginRight: "10px",width:'36px',height:'36px',borderRadius:'4px' }}
                    >
                    ...
                    <button
                        ...
                        style={{ padding: "0px", marginLeft: "10px",marginRight: "10px",width:'36px',height:'36px',borderRadius:'4px' }}
                    >
