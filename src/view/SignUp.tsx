...
const SignUp = ({setSignUpForm}:SignUpForm) => {
    ...
    if (isSuccess && !isLoading && !isError && !error) {
        ...
        setStatus(SNACKBAR_TYPE.ERROR,(error as any)?.response?.data?.message || "Something went wrong");
    }
        ...
        <div className="form-wrapper">
            ...
            <div className="form-group">
                ...
                />
                {
                    formik.errors && formik.errors?.firstName && 
                    formik.touched && formik.touched?.firstName && 
                    <div className="invalid-feedback">{formik.errors?.firstName as string || ""}</div>
                }
            </div>
            <div className="form-group">
                ...
                />
                {
                    formik.errors && formik.errors?.lastName && 
                    formik.touched && formik.touched?.lastName && 
                    <div className="invalid-feedback">{formik.errors?.lastName as string || ""}</div>
                }
            </div>
            <div className="form-group">
                <label>Email</label>
           ...
           <div className="form-group">
                ...
                />
                {
                    formik.errors && formik.errors?.password && 
                    formik.touched && formik.touched?.password && 
                    <div className="invalid-feedback">{formik.errors?.password as string || ""}</div>
                }
            </div>
            <Button
                type={"submit"}
